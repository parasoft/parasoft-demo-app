...
@DirtiesContext
public class DefenseDefaultDataSpringTest {
	...
	/**
	 * test for if default assets of defense industry are successfully created
	 */
	@Test
	public void testDefaultDefenseAssetsSuccessfullyCreated() throws Throwable {
		// Given
		// switch database to DEFENSE
		IndustryRoutingDataSource.currentIndustry = IndustryType.DEFENSE;

		// When
		// get all categories of defense industry
		String searchString = "";
		...
		assertTrue(categories.getContent().get(0).getImage().startsWith("/defense"));
		...
		assertTrue(items.get(0).getImage().startsWith("/defense"));
	}
	
	/**
	 * test for if default locations of defense industry are successfully created
	 */
	@Test
	public void testDefaultDefenseLocationsSuccessfullyCreated() throws Throwable {
		// Given
		// switch database to DEFENSE
		IndustryRoutingDataSource.currentIndustry = IndustryType.DEFENSE;
	 ...
	 */
	@Test
	public void testDefaultDefenseOrdersSuccessfullyCreated() throws Throwable {
		// Given
		// switch database to DEFENSE
		IndustryRoutingDataSource.currentIndustry = IndustryType.DEFENSE;
...
//		assertTrue(orders.size() > 0);
	...
	/**
	 * test for if default overrided labels of defense industry are successfully created
	 */
	@Test
	public void testDefaultOutdoorOverridedLabelsSuccessfullyCreated() throws Throwable {
		...
		// When
		// get all overrided labels of defense industry
