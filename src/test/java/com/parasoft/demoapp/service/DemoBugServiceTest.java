...
public class DemoBugServiceTest {
    ...
    /**
     * Test for introduceBugWithCannotDetermineTargetDatasourceIfNeeded()
     *
     * @see DemoBugService#introduceBugWithCannotDetermineTargetDatasourceIfNeeded()
     */
    @Test
    public void testIntroduceBugWithCannotDetermineTargetDatasourceIfNeeded_bugIsIntroduced() throws Throwable {
        // Given
        doNothing().when(industryRoutingDataSource).afterPropertiesSet();
        GlobalPreferencesEntity globalPreferencesEntity = new GlobalPreferencesEntity();
        Set<DemoBugEntity> demoBugEntities = new TreeSet<>(new BugsTypeSortOfDemoBugs());
        demoBugEntities.add(new DemoBugEntity(DemoBugsType.REINITIALIZE_DATASOURCE_FOR_EACH_HTTP_REQUEST));
        globalPreferencesEntity.setDemoBugs(demoBugEntities);
        doReturn(globalPreferencesEntity).when(globalPreferencesService).getCurrentGlobalPreferences();

        // When
        underTest.introduceBugWithCannotDetermineTargetDatasourceIfNeeded();

        // Then
        verify(industryRoutingDataSource, times(1)).afterPropertiesSet();
    }
     ...
     */
    @Test
    public void testIntroduceBugWithCannotDetermineTargetDatasourceIfNeeded_IsNotIntroduced_noBugs() throws Throwable {
        // Given
        doNothing().when(industryRoutingDataSource).afterPropertiesSet();
        GlobalPreferencesEntity globalPreferencesEntity = new GlobalPreferencesEntity();
        Set<DemoBugEntity> demoBugEntities = new TreeSet<>(new BugsTypeSortOfDemoBugs());
        demoBugEntities.add(new DemoBugEntity(DemoBugsType.REVERSE_ORDER_OF_ORDERS));   // No wanted bug
        globalPreferencesEntity.setDemoBugs(demoBugEntities);
        doReturn(globalPreferencesEntity).when(globalPreferencesService).getCurrentGlobalPreferences();
        ...
        // Then
        verify(industryRoutingDataSource, times(0)).afterPropertiesSet();
    }
     ...
     */
    @Test
    public void testIntroduceBugWithCannotDetermineTargetDatasourceIfNeeded_exception() throws Throwable {
        // Given
        doNothing().when(industryRoutingDataSource).afterPropertiesSet();
        GlobalPreferencesEntity globalPreferencesEntity = new GlobalPreferencesEntity();
        Set<DemoBugEntity> demoBugEntities = new TreeSet<>(new BugsTypeSortOfDemoBugs());
        globalPreferencesEntity.setDemoBugs(demoBugEntities);
        doThrow(GlobalPreferencesNotFoundException.class).when(globalPreferencesService).getCurrentGlobalPreferences();
