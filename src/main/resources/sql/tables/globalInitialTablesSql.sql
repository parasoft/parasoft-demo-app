...
CREATE TABLE IF NOT EXISTS TBL_GLOBAL_PREFERENCES (
    ...
    MQ_TYPE VARCHAR(255),
    ORDER_SERVICE_ACTIVE_MQ_REQUEST_QUEUE VARCHAR(255),
    ORDER_SERVICE_ACTIVE_MQ_RESPONSE_QUEUE VARCHAR(255),
    ORDER_SERVICE_KAFKA_REQUEST_TOPIC VARCHAR(255),
    ORDER_SERVICE_KAFKA_RESPONSE_TOPIC VARCHAR(255),
    ORDER_SERVICE_RABBIT_MQ_REQUEST_QUEUE VARCHAR(255),
    ORDER_SERVICE_RABBIT_MQ_RESPONSE_QUEUE VARCHAR(255),
