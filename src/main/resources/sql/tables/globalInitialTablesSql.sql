...
CREATE TABLE IF NOT EXISTS TBL_GLOBAL_PREFERENCES (
    ...
    ORDER_SERVICE_REQUEST_TOPIC VARCHAR(255),
    ORDER_SERVICE_RESPONSE_TOPIC VARCHAR(255),
    ORDER_SERVICE_REQUEST_QUEUE VARCHAR(255),
    ORDER_SERVICE_RESPONSE_QUEUE VARCHAR(255),
