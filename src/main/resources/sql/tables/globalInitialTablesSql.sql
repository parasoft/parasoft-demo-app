...
CREATE TABLE IF NOT EXISTS TBL_GLOBAL_PREFERENCES (ID BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 1, INCREMENT BY 1) NOT NULL, DATA_ACCESS_MODE VARCHAR(255), INDUSTRY_TYPE VARCHAR(255), REST_END_POINT VARCHAR(255), SOAP_END_POINT VARCHAR(255), AD_ENABLED TINYINT, USE_PARASOFT_JDBC_PROXY TINYINT, PARASOFT_VIRTUALIZE_SERVER_URL VARCHAR(255), PARASOFT_VIRTUALIZE_SERVER_PATH VARCHAR(255), PARASOFT_VIRTUALIZE_GROUP_ID VARCHAR(255), LABELS_OVERRIDED TINYINT, CONSTRAINT SYS_PK_11066 PRIMARY KEY (ID))
