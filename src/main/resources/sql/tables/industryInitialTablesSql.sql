...
CREATE TABLE IF NOT EXISTS TBL_ITEM_INVENTORY (ITEM_ID BIGINT NOT NULL, IN_STOCK INTEGER, CONSTRAINT SYS_PK_10098 PRIMARY KEY (ITEM_ID), CONSTRAINT TBL_ITEM_INVENTORY_FK FOREIGN KEY (ITEM_ID) REFERENCES TBL_ITEM(ID));
