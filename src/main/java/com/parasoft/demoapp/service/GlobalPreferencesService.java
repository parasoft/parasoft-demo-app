...
public class GlobalPreferencesService {
    ...
    */
    ...
    public void checkMqStatusHasChanged(GlobalPreferencesEntity currentPreferences,
                                        GlobalPreferencesDTO globalPreferencesDto) {
        String orderServiceSendTo = globalPreferencesDto.getOrderServiceSendTo();
        String orderServiceListenOn = globalPreferencesDto.getOrderServiceListenOn();
        if (globalPreferencesDto.getMqType() == MqType.ACTIVE_MQ){
    ...
    private void validateMqConfig(GlobalPreferencesDTO globalPreferencesDto) throws ParameterException {
        ...
        String orderServiceListenOn = globalPreferencesDto.getOrderServiceListenOn();
        if (globalPreferencesDto.getMqType() == MqType.ACTIVE_MQ) {
            ParameterValidator.requireNonBlank(orderServiceSendTo, GlobalPreferencesMessages.ORDER_SERVICE_DESTINATION_QUEUE_CANNOT_BE_NULL);
            ParameterValidator.requireNonBlank(orderServiceListenOn, GlobalPreferencesMessages.ORDER_SERVICE_REPLY_TO_QUEUE_CANNOT_BE_NULL);
        } else if (globalPreferencesDto.getMqType() == MqType.KAFKA) {
            ParameterValidator.requireNonBlank(orderServiceSendTo, GlobalPreferencesMessages.ORDER_SERVICE_REQUEST_TOPIC_CANNOT_BE_NULL);
            ParameterValidator.requireNonBlank(orderServiceListenOn, GlobalPreferencesMessages.ORDER_SERVICE_RESPONSE_TOPIC_CANNOT_BE_NULL);
        }
    }
