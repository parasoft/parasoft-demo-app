...
@Component
@Slf4j
@Order(14) // The order of default data creation
public class OutdoorIndustryShippingCreator extends AbstractDataCreator {
	...
	@Value("classpath:sql/defaultdata/outdoor/tbl_shipping-defaultData.sql")
	protected Resource outdoorDefaultShipTypesSql;
	...
	public void populateData() {
		...
		dataInitialize(industryDataSource, outdoorDefaultShipTypesSql);
