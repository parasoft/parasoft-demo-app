...
public class GlobalPreferencesMessages extends Messages {
    ...
    public static final String ORDER_SERVICE_REQUEST_TOPIC_CANNOT_BE_NULL = "orderServiceRequestTopic cannot be null or empty.";
    public static final String ORDER_SERVICE_RESPONSE_TOPIC_CANNOT_BE_NULL = "orderServiceResponseTopic cannot be null or empty.";
